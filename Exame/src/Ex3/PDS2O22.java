...
public class PDS2O22 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		// NAO CONSEGUI FAZER COM QUE O CODIGO FOSSE IMPRESSO NUM FICHEIRO TXT PORQUE ESTA NOUTRA PASTA
	...
	private static void question3(PrintStream out) {
		out.println("\nQuestion 3) ----------------------------------\n");
		ToShare market = new ToShare();
		Product a = new Car("ZA11ZB", "Tesla, Grey, 2021", 100);
		Product b = new Van("AA22BB", "Chevrolet Chevy, 2020", 180);
		Product c = new Motorcycle("ZA33ZB", "Touring, 750, 2022", 85);
		market.add(a);
		market.add(b);
		market.add(c);
