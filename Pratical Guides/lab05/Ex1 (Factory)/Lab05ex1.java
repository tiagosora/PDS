...
import Ex1.Portion.Temperature;                                // AND THE "EX1." IN THIS LINE
public class Lab05ex1 {
    public static void main(String[] args) {
        final int MENUS = 4;
        Portion[] menu = new Portion[MENUS];
        menu[0] = PortionFactory.create("Beverage",Temperature.COLD); // It's possible to create with a third arguemnt for FruitJuices
